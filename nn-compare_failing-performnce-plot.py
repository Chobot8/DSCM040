...
# -----------------------------------------------
fig, ax1 = plt.subplots()
performance_df.plot(x='Model', y='Test Loss', kind='bar', ax=ax1, color='r', position=0)
ax1.set_ylabel('Test Loss', color='r')
ax2 = ax1.twinx()
performance_df.plot(x='Model', y='Test Accuracy', kind='bar', ax=ax2, color='b', position=1)
...
print(f"Resource usage plot saved as {resource_usage_plot_file}")
